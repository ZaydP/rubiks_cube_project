...
def energy_of_config(config):     # Energy contribution of site [j,k]
    energy=0
    for pos in np.arange(1,len(config)+1,1):
        config_neighbours = neighbours_fn(pos)
        # print(config_neighbours)
...
for i in range(sweeps):
    ...
    energies[i] = energy_of_config(swept_cube)
